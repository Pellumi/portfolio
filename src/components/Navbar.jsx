...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`fixed top-0 w-full max-w-[1440px] px-[7%] py-8 flex items-center z-[100] duration-500 max-[1024px]:py-8 max-[1024px]:px-[3%] ${isActive || isSticky ? 'bg-bg-color dark:bg-bg-color-dark' : 'bg-transparent'}`}>
