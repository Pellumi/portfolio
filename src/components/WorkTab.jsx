...
export const WorkTab = ({ src, alt, title, description, stack, link, github }) => {
  return (
    <div className='flex flex-col items-center gap-16 lg:flex-row'>
      ...
      <div className="flex-1 text-center lg:text-left">
        ...
        <ul className="flex mb-14 gap-12">
...
export const ReverseWorkTab = ({ src, alt, title, description, stack, link, github }) => {
  return (
